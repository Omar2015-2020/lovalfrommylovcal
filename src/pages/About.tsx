  ...
  return (
    <div className="min-h-screen">
      <HeroSection
        ...
        subtitle="Learn about our history, mission, and the people behind the Yemeni Community in Russia"
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <SectionHeader 
            ...
            subtitle="Meet the dedicated team leading our community initiatives"
          />
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-lg mt-2">Community Members</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-gold">15+</p>
              <p className="text-lg mt-2">Russian Cities</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-gold">20+</p>
              <p className="text-lg mt-2">Annual Events</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-gold">30+</p>
              <p className="text-lg mt-2">Years of History</p>
            </div>
          </div>
        </div>
      </section>
